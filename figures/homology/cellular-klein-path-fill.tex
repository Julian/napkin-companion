% Klein bottle square: the doubled cycle bounds a shaded strip after
% pulling one arc across the identified blue edge.
...
\begin{tikzpicture}[scale=2.2]
  ...
  \fill[cyan!25] (0,0.3) rectangle (1,0.7);
  \draw[midarrow] (0,0.7) -- (1,0.7);
  \draw[midarrow] (1,0.3) -- (0,0.3);
