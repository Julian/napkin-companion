...
\begin{tikzpicture}[scale=0.95]
  ...
  \fill[red] (-0.960,1.100) circle (1.4pt); \node[red,font=\scriptsize] at (-0.748,1.312) {$z_{0}$};
  ...
  \draw[blue,thick] plot[smooth] coordinates {(0.035,1.176) (0.500,1.100) (0.757,1.398) (0.740,1.717) (0.549,1.929) (0.278,1.979) (0.022,1.849)};
  ...
  \fill[blue] (0.109,-1.553) circle (1.4pt); \node[blue,font=\scriptsize] at (-0.150,-1.703) {$w_{6}$};
