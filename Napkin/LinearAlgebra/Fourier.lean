...
:::aside "Formalizing binary Fourier analysis"
...
The abstract statement standing behind both rows here is the `HilbertBasis.tsum_inner_mul_inner` identity we met at the start of the chapter.
