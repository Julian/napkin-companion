...
Exercises are labelled — "Lean exercise", numbered alongside the chapter's other callouts — and their proof is left as `sorry`; the paragraph just before each one names the pieces to reach for and the shape of the argument, without writing it out.
